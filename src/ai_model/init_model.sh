...
MODEL_NAME=cls_image_sharp_v1.0.0
MODEL_DIR=model
INSTALL_DIR=/home/guoweiye/workspace/image_clarity/src
...
if [[ $GPU_TYPE == *"Tesla P40 "* ]]; then
    ...
    libs/linux/gpu/performance_testing_GPU ${MODEL_DIR}/${MODEL_NAME}.onnx images/testing ${MODEL_DIR}/config.ini
